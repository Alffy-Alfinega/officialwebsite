        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-2 mb-5 group" aria-label="Alffy (Alfinega) home">
              <Image src="/logo-nav.png" alt="Alffy (Alfinega) logo" width={40} height={40} className="transition-opacity duration-300 group-hover:opacity-80" />
            ...
            <div className="mt-6 space-y-2">
              <a href="mailto:contact@alfinega.com" className="block font-outfit transition-colors hover:text-white" style={{ color: 'var(--text-faint)' }}>
                contact@alfinega.com
              </a>
              <a href="tel:+256747113059" className="block font-outfit text-sm hover:text-[#2C6FED] transition-colors" style={{ color: 'var(--text-muted)' }}>
                +256 747 113 059
              </a>
