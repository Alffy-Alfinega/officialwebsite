    ...
    <div className="pt-[68px]">
      ...
      <section className="relative py-24 md:py-32 px-6 md:px-16 lg:px-24 max-w-[1440px] mx-auto overflow-hidden">
        <div className="absolute right-0 top-0 w-1/2 h-full opacity-100 pointer-events-none">
          <FloatingGeometryWrapper className="w-full h-full" variant="careers" />
        </div>
          ...
          {openRoles.map((role) => (
            ...
            >
              ...
              <div className="p-7 md:p-8 flex flex-col md:flex-row md:items-start md:justify-between gap-4">
                ...
                <a
                  href={`mailto:hello@alfinega.com?subject=Application: ${encodeURIComponent(role.title)}&body=Hi Alffy team,%0A%0AI'm applying for the ${encodeURIComponent(role.title)} role.%0A%0A[Tell us about yourself and attach your CV / portfolio]`}
      ...
      {/* No roles / spontaneous application */}
      <section className="py-12 px-6 md:px-16 lg:px-24 max-w-[1440px] mx-auto pb-28">
        ...
        >
          ...
          <a
            href="mailto:hello@alfinega.com?subject=Spontaneous Application — [Your Role]&body=Hi Alffy team,%0A%0AI'd like to introduce myself and explore whether there's a fit.%0A%0A[Tell us about yourself and attach your CV / portfolio]"
