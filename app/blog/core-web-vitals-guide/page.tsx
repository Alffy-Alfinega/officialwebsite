    ...
    <div style={{ paddingTop:68, minHeight:'100vh' }}>
      <div style={{ maxWidth:760, margin:'0 auto', padding:'80px 40px' }}>
        ...
        <div style={{ display:'flex', gap:10, marginBottom:20, marginTop:16 }}>
          ...
          <span style={{ fontFamily:"'JetBrains Mono',monospace", fontSize:10, color:'#6A6A8A' }}>5 min read</span>
        </div>
        <h1 style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:'clamp(1.8rem,4vw,3rem)', lineHeight:1.1, color:'#E4E4F0', marginBottom:32 }}>Core Web Vitals for Ugandan Websites: A Plain-Language Guide</h1>
