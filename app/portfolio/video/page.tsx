...
export const metadata: Metadata = { title: 'Video & Animation Portfolio' }
  ...
  return (
    <div style={{ paddingTop:68, minHeight:'100vh' }}>
      <div style={{ maxWidth:1100, margin:'0 auto', padding:'80px 40px' }}>
        ...
        <h1 style={{ fontFamily:"'Syne',sans-serif", fontWeight:800, fontSize:'clamp(2.2rem,5vw,4rem)', lineHeight:0.92, letterSpacing:'-0.03em', color:'#E4E4F0', marginBottom:16 }}>Video & Animation Portfolio</h1>
