...
const service = {
  slug: 'seo-services', number: '02', title: 'SEO Services', shortTitle: 'SEO',
  tagline: 'Rank. Be found. Grow.',
  description: 'Comprehensive SEO strategies that boost your organic visibility and drive qualified traffic. From technical audits to content optimisation, we make sure your audience finds you — not your competitors.',
  features: ['Technical SEO audits', 'On-page optimisation', 'Local SEO (Uganda & East Africa)', 'Keyword research & strategy', 'Link building', 'Monthly performance reports'],
  deliverables: ['SEO audit report', 'Keyword strategy doc', 'Monthly ranking reports', 'Actionable roadmap'],
}

const prev = { slug: 'website-design', title: 'Website Design' }
const next = { slug: 'graphic-design', title: 'Graphic Design' }

export const metadata: Metadata = {
  title: 'SEO Services | Alffy — Kampala, Uganda',
