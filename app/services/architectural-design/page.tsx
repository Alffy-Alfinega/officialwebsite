...
const service = {
  slug: 'architectural-design', number: '09', title: 'Architectural Design', shortTitle: 'Architecture',
  tagline: "Vision before it's built",
  description: 'Professional architectural visualisation that lets clients see their project before the first brick is laid. Photorealistic renders, walkthroughs, and floor plans that sell the dream.',
  features: ['Exterior visualisation', 'Interior renders', '3D walkthroughs & flythroughs', 'Floor plan design', 'Landscape visualisation', 'Virtual staging'],
  deliverables: ['High-res renders', 'Walkthrough video', 'Floor plan files', 'VR-ready scenes'],
}

const prev = { slug: 'animation', title: '2D & 3D Animation' }
const next = { slug: 'content-creation', title: 'Content Creation' }

export const metadata: Metadata = {
  title: 'Architectural Design | Alffy — Kampala, Uganda',
