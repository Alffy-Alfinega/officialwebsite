...
const service = allServices.find((s) => s.slug === 'seo-marketing')!
const currentIndex = allServices.findIndex((s) => s.slug === 'seo-marketing')
...
export const metadata: Metadata = {
  title: 'SEO & Digital Marketing — Grow Your Reach | Alffy Kampala',
  description: 'SEO and digital marketing services in Kampala, Uganda. Technical SEO, local SEO, paid ads, social media management, and content marketing.',
}
    ...
    <div className="pt-[68px]">
      <section className="relative min-h-[60vh] flex items-end overflow-x-hidden px-6 md:px-16 lg:px-24 pb-16 pt-32">
        <div className="absolute right-0 top-0 w-full md:w-1/2 h-full pointer-events-none">
          <BabylonScene variant="seo-marketing" className="w-full h-full" />
        </div>
