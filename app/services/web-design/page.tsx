...
const service = allServices.find((s) => s.slug === 'web-design')!
const currentIndex = allServices.findIndex((s) => s.slug === 'web-design')
...
export const metadata: Metadata = {
  title: 'Web Design & Development — Custom Websites | Alffy Kampala',
  description: 'Professional web design and development in Kampala, Uganda. Responsive, fast, and conversion-focused websites built with Next.js and React.',
}
    ...
    <div className="pt-[68px]">
      <section className="relative min-h-[60vh] flex items-end overflow-x-hidden px-6 md:px-16 lg:px-24 pb-16 pt-32">
        <div className="absolute right-0 top-0 w-full md:w-1/2 h-full pointer-events-none">
          <BabylonScene variant="web-design" className="w-full h-full" />
        </div>
