...
const service = {
  slug: 'image-editing', number: '07', title: 'Image Editing', shortTitle: 'Photo Edit',
  tagline: 'Perfect. Every. Pixel.',
  description: 'High-quality image editing and enhancement for web, social media, and print. We handle everything from basic retouching to complex composites — your visuals, elevated.',
  features: ['Product photo retouching', 'Background removal & replacement', 'Colour correction', 'Photo compositing', 'Batch editing', 'Format conversion & compression'],
  deliverables: ['Edited image files', 'Web & print formats', 'Original backups'],
}

const prev = { slug: 'video-editing', title: 'Video Editing' }
const next = { slug: 'animation', title: '2D & 3D Animation' }

export const metadata: Metadata = {
  title: 'Image Editing | Alffy — Kampala, Uganda',
