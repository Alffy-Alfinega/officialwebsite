...
const service = {
  slug: 'digital-marketing', number: '05', title: 'Digital Marketing', shortTitle: 'Marketing',
  tagline: 'Campaigns built to convert',
  description: 'Strategic digital marketing that reaches your audience where they live. From social media management to paid ad campaigns, we deliver measurable ROI — not vanity metrics.',
  features: ['Social media strategy & management', 'Paid advertising (Meta, Google)', 'Email marketing campaigns', 'Analytics & conversion tracking', 'Influencer coordination', 'Content calendar planning'],
  deliverables: ['Campaign strategy deck', 'Ad creatives', 'Monthly analytics report', 'Optimisation roadmap'],
}

const prev = { slug: 'branding', title: 'Branding' }
const next = { slug: 'video-editing', title: 'Video Editing' }

export const metadata: Metadata = {
  title: 'Digital Marketing | Alffy — Kampala, Uganda',
