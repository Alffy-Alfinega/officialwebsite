...
const service = {
  slug: 'cybersecurity', number: '11', title: 'Cybersecurity', shortTitle: 'Security',
  tagline: 'Protect what you have built',
  description: 'Comprehensive digital security services that protect your business, website, and customer data. From vulnerability audits to ongoing monitoring, we keep threats out before they get in.',
  features: ['Website security audits', 'SSL & HTTPS configuration', 'Malware scanning & removal', 'Firewall setup & hardening', 'Data breach risk assessment', 'Security monitoring & alerts'],
  deliverables: ['Security audit report', 'Vulnerability fix log', 'Monitoring dashboard', 'Incident response plan'],
}

const prev = { slug: 'content-creation', title: 'Content Creation' }
const next = { slug: 'data-entry', title: 'Mass Data Entry' }

export const metadata: Metadata = {
  title: 'Cybersecurity | Alffy — Kampala, Uganda',
