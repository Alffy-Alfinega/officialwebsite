...
const service = {
  slug: 'video-editing', number: '06', title: 'Video Editing', shortTitle: 'Video',
  tagline: 'Raw footage → compelling story',
  description: 'Professional video editing that transforms your raw footage into polished, narrative-driven content. We handle colour grading, motion graphics, sound, and everything else that separates good from great.',
  features: ['Commercial & promo videos', 'Social media video cuts', 'Colour grading & correction', 'Motion graphics & titles', 'Sound design & mixing', 'Multi-format delivery'],
  deliverables: ['Master video file', 'Platform-optimised cuts', 'Project file', 'Thumbnail designs'],
}

const prev = { slug: 'digital-marketing', title: 'Digital Marketing' }
const next = { slug: 'image-editing', title: 'Image Editing' }

export const metadata: Metadata = {
  title: 'Video Editing | Alffy — Kampala, Uganda',
