...
const service = allServices.find((s) => s.slug === 'cybersecurity-data')!
const currentIndex = allServices.findIndex((s) => s.slug === 'cybersecurity-data')
...
export const metadata: Metadata = {
  title: 'Cybersecurity & Data Services — Protect & Scale | Alffy',
  description: 'Cybersecurity audits, malware protection, and mass data entry services in Kampala, Uganda. Secure your business and manage data at scale.',
}

export default function CybersecurityDataPage() {
  return (
    <div className="pt-[68px]">
      <section className="relative min-h-[60vh] flex items-end overflow-x-hidden px-6 md:px-16 lg:px-24 pb-16 pt-32">
        <div className="absolute right-0 top-0 w-full md:w-1/2 h-full pointer-events-none">
          <BabylonScene variant="cybersecurity" className="w-full h-full" />
        </div>
