...
const service = {
  slug: 'branding', number: '04', title: 'Branding', shortTitle: 'Branding',
  tagline: 'Identity engineered for impact',
  description: 'Complete branding solutions that define who you are before you say a word. We build cohesive brand identities — logo, colour, voice, and everything in between — that your audience remembers.',
  features: ['Logo design & variations', 'Brand colour palette', 'Typography system', 'Brand voice & messaging', 'Brand guidelines document', 'Stationery & collateral design'],
  deliverables: ['Logo files (all formats)', 'Brand guidelines PDF', 'Asset library', 'Stationery pack'],
}

const prev = { slug: 'graphic-design', title: 'Graphic Design' }
const next = { slug: 'digital-marketing', title: 'Digital Marketing' }

export const metadata: Metadata = {
  title: 'Branding | Alffy — Kampala, Uganda',
