...
const service = {
  slug: 'animation', number: '08', title: '2D & 3D Animation', shortTitle: 'Animation',
  tagline: 'Stories that move people',
  description: 'Captivating 2D and 3D animations that breathe life into your ideas. From explainer videos and motion graphics to full 3D renders, we make the complex beautifully simple.',
  features: ['2D motion graphics', '3D product animations', 'Explainer videos', 'Animated logos & intros', 'Character animation', 'Visual effects (VFX)'],
  deliverables: ['Animation files', 'Source project files', 'Platform-ready exports'],
}

const prev = { slug: 'image-editing', title: 'Image Editing' }
const next = { slug: 'architectural-design', title: 'Architectural Design' }

export const metadata: Metadata = {
  title: '2D & 3D Animation | Alffy — Kampala, Uganda',
