...
const service = {
  slug: 'website-design', number: '01', title: 'Website Design', shortTitle: 'Web Design',
  tagline: 'Experiences that convert',
  description: 'Modern, responsive websites built to convert visitors into loyal customers. We craft digital experiences that balance stunning visuals with intuitive UX — your brand, expressed at its absolute best.',
  features: ['Custom UI/UX design', 'Mobile-first responsive development', 'Next.js & React development', 'CMS integration (WordPress, Sanity)', 'Performance optimisation', 'Accessibility compliance'],
  deliverables: ['Design mockups', 'Responsive website', 'CMS training', 'Post-launch support'],
}

const prev = { slug: 'data-entry', title: 'Mass Data Entry' }
const next = { slug: 'seo-services', title: 'SEO Services' }

export const metadata: Metadata = {
  title: 'Website Design | Alffy — Kampala, Uganda',
