...
const service = allServices.find((s) => s.slug === 'media-production')!
const currentIndex = allServices.findIndex((s) => s.slug === 'media-production')
...
export const metadata: Metadata = {
  title: 'Video, Animation & Image Editing — Media Production | Alffy',
  description: 'Professional video editing, 2D/3D animation, and image editing services in Kampala, Uganda. Commercials, explainers, product edits.',
}
    ...
    <div className="pt-[68px]">
      <section className="relative min-h-[60vh] flex items-end overflow-x-hidden px-6 md:px-16 lg:px-24 pb-16 pt-32">
        <div className="absolute right-0 top-0 w-full md:w-1/2 h-full pointer-events-none">
          <BabylonScene variant="media-production" className="w-full h-full" />
        </div>
