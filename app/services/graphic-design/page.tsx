...
const service = {
  slug: 'graphic-design', number: '03', title: 'Graphic Design', shortTitle: 'Graphics',
  tagline: 'Visual language that speaks',
  description: 'Eye-catching graphics that narrate your brand story with precision. From social media content to print collateral, every pixel is intentional.',
  features: ['Social media graphics', 'Print materials (flyers, brochures)', 'Presentations & pitch decks', 'Infographics & data visualisation', 'Display advertising', 'Icon & illustration sets'],
  deliverables: ['Print-ready files', 'Web-optimised assets', 'Source files', 'Style guide'],
}

const prev = { slug: 'seo-services', title: 'SEO Services' }
const next = { slug: 'branding', title: 'Branding' }

export const metadata: Metadata = {
  title: 'Graphic Design | Alffy — Kampala, Uganda',
