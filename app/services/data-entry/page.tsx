...
const service = {
  slug: 'data-entry', number: '12', title: 'Mass Data Entry', shortTitle: 'Data Entry',
  tagline: 'Accurate. Fast. Scalable.',
  description: 'Professional mass data entry services for businesses that need large volumes of data processed quickly and accurately. From product catalogues to database migration, we handle the volume so you can focus on the business.',
  features: ['Product catalogue data entry', 'Database population & migration', 'Spreadsheet & CRM data entry', 'Document digitisation', 'Form processing & data extraction', 'Quality assurance & validation'],
  deliverables: ['Completed dataset', 'QA validation report', 'Structured file exports', 'Error log & corrections'],
}

const prev = { slug: 'cybersecurity', title: 'Cybersecurity' }
const next = { slug: 'website-design', title: 'Website Design' }

export const metadata: Metadata = {
  title: 'Mass Data Entry | Alffy — Kampala, Uganda',
