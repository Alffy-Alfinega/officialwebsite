...
const service = allServices.find((s) => s.slug === 'branding-design')!
const currentIndex = allServices.findIndex((s) => s.slug === 'branding-design')
...
export const metadata: Metadata = {
  title: 'Branding & Graphic Design — Visual Identity | Alffy Kampala',
  description: 'Brand identity and graphic design services in Kampala, Uganda. Logo design, brand guidelines, print materials, and social media graphics.',
}
    ...
    <div className="pt-[68px]">
      <section className="relative min-h-[60vh] flex items-end overflow-x-hidden px-6 md:px-16 lg:px-24 pb-16 pt-32">
        <div className="absolute right-0 top-0 w-full md:w-1/2 h-full pointer-events-none">
          <BabylonScene variant="branding-design" className="w-full h-full" />
        </div>
