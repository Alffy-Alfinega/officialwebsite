...
| `/services/{12 services}` | 0.8 | [[components/r3f#Per-Service Slug Scenes]] | [[business/services]] | Service detail (individual page per service) |
...
| `/blog/{6 posts}` | 0.6 | [[components/r3f#Scene Variants\|TextWaveScene]] | [[business/blog]] | Blog article (individual page per post) |
