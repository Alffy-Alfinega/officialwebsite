...
Rendered on [[routes/map#Page Routes\|/about]] and `/about/story` pages. Structured data references this info (see [[routes/seo#Structured Data]]).

| Field | Value |
|---|---|
| Legal Name | Alffy (Alfinega) |
...
- Mid 2025 — Development and testing phase
- Late 2025 — Added animation, arch viz, video, content (see [[business/services]])
- Jan 2026 — Official public launch (all 12 services)
- Early 2026 — Alffy v2 launched (full rebrand — this project)

## 2026 Targets
- 50+ projects, 95% satisfaction, 24/7 support
- Services deployed: [[business/services]], pricing: [[business/pricing]]
